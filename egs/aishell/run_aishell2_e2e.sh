...
data_set=aishell2
data_path=/home/work_nfs3/jjchen/github/SMLAT/egs/aishell/data/$data_set
no_dev=false
...
dumpdir=$data_set   # directory to dump full features
...
feat_cv_dir=dump/${dumpdir}/dev/delta${do_delta}; mkdir -p ${feat_cv_dir}
