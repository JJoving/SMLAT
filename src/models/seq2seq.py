...
class Seq2Seq(nn.Module):
    ...
    def forward(self, padded_input, input_lengths, padded_target):
        ...
        #import time
        if self.ctc_las:
            encoder_padded_outputs, ctc_output,  _ = self.encoder(padded_input, input_lengths)
            x, y = ctc_truncate(ctc_output, padded_target, encoder_padded_outputs, blank = 4233)
