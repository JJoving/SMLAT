...
from lstmctc import Lstmctc
from solver import Solver
from utils import process_ctc_dict
...
def main(args):
    ...
    char_list = process_ctc_dict(args.dict)
    vocab_size = len(char_list)
    data = {'tr_loader': tr_loader, 'cv_loader': cv_loader}
    # model
    lstm = Lstm(args.einput, args.ehidden, args.elayer, vocab_size,
